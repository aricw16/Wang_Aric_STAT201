...
if (var_seconds %/% 60 == 1){
  if (var_seconds %% 60 == 1){
    cat(var_seconds, " seconds is ", a, " minute and ", b, " second.", sep = "")
  }else{
    cat(var_seconds, " seconds is ", a, " minute and ", b, " seconds.", sep = "")  }
}else if(var_seconds %% 60 == 1){
  cat(var_seconds, " seconds is ", a, " minutes and ", b, " second.", sep = "")  
}else{
  cat(var_seconds, " seconds is ", a, " minutes and ", b, " seconds.", sep = "")  
}
...
for (i in 1:num){
  if (i^2 > num){
    cat(i, ' squared is ', i^2, ', and is the first number whose square exceeds ', num,'.',sep ="")
    break
  }
}
